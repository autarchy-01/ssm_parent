	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a href="${pageContext.request.contextPath}/product/findAllProduct">产品管理</a></li>
				<li class="active">产品修改</li>
			</ol>
			</section>
			<!-- 内容头部 /-->

			<form action="${pageContext.request.contextPath}/product/updateProduct"
				method="post">
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									...
									value="<fmt:formatDate value="${product.departureTime}" pattern="yyyy-MM-dd HH:mm"/>">
							</div>
						</div>
