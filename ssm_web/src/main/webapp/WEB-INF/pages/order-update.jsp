...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content"> <!--订单信息-->
            <form action="${pageContext.request.contextPath}/orders/updateOrders"
                  method="post">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right"
                                       ...
                                       value="<fmt:formatDate value="${orders.orderTime}" pattern="yyyy-MM-dd HH:mm"/>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right"
                                       id="datepicker-a6"
                                       value="<fmt:formatDate value="${orders.product.departureTime}" pattern="yyyy-MM-dd HH:mm"/>"
                        ...
                        <div class="row data-type">
                            ...
                            <div class="col-md-4 data text">
                                <select class="form-control select2" style="width: 100%" name="payType">
                                    <option value="0" <c:if test="${orders.payType==0}">selected="selected"</c:if>>支付宝
                                    </option>
                                    <option value="1" <c:if test="${orders.payType==1}">selected="selected"</c:if>>微信
                                    </option>
                                    <option value="2" <c:if test="${orders.payType==2}">selected="selected"</c:if>>其他
                                    </option>
                                </select>
                            </div>

                            <div class="col-md-2 title">金额</div>
                            <div class="col-md-4 data text">￥<input type="text" value="${orders.product.productPrice}"
                                                                    name="product.productPrice" readonly="readonly">
                            </div>
