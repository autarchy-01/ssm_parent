	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/WEB-INF/pages/order-list.jsp">订单管理</a></li>
							...
							<div class="form-group form-inline">
								<div class="btn-group">
									<button type="button" class="btn btn-default" title="新建"
										onclick='location.href="order-update.jsp"'>
								...
								<tr>
									...
									<td class="text-center">
										<button type="button" class="btn bg-olive btn-xs"
											onclick='location.href="order-show.jsp"'>订单</button>
										<button type="button" class="btn bg-olive btn-xs"
											onclick='location.href="order-show.jsp"'>查看</button>
									</td>
								</tr>
